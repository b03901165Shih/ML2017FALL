...
for i in range(user_test.shape[0]):
  user_train_trait[i] = userTrait[user_test[i][0]]
...
y_pred = model.predict([user_test, movies_test,user_train_trait], verbose = 1, batch_size=batch_size)
